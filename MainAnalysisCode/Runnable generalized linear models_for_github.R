#Code Written by Ella Poole
#With some edits by Dr. Mary Regina Boland

#Runnable generalized linear models to get final output for manuscript
#Ella Poole
...
data = read.csv("https://raw.githubusercontent.com/bolandlab/Fracking_EndocrineDisruption_BirthOutcomes/main/MainAnalysisCode/full_data.csv")
...
ua_subset = read.csv("https://raw.githubusercontent.com/bolandlab/Fracking_EndocrineDisruption_BirthOutcomes/main/MainAnalysisCode/unambiguous_subset.csv")
...
fm_subset = read.csv("https://raw.githubusercontent.com/bolandlab/Fracking_EndocrineDisruption_BirthOutcomes/main/MainAnalysisCode/farming_and_mining_subset.csv")
#'non-metro subset' which contains data on US counties that are designated as non-metro by the USDA
nm_subset = read.csv("https://raw.githubusercontent.com/bolandlab/Fracking_EndocrineDisruption_BirthOutcomes/main/MainAnalysisCode/non_metro_subset.csv")
...
#This file is stored at: the following location on github: https://raw.githubusercontent.com/bolandlab/Fracking_EndocrineDisruption_BirthOutcomes/main/MainAnalysisCode/glm_results.csv